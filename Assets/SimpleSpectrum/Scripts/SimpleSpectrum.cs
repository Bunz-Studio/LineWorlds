...
#region COLOR PROPERTIES
    ...
    public void SetTheBarAmount(float slider){
    	barAmount = int.Parse(slider.ToString());
    }
    public void SetBarHeight(float slider){
    	barYScale = slider;
    }
    public void SetBarXSize(float slider){
    	barXScale = slider;
    }
    public void SetBarXSpacing(float slider){
    	barXSpacing = slider;
    }
    public void ChangeAttackDamp(float slider){
    	attackDamp = slider;
    }
    public void ChangeDecayDamp(float slider){
    	decayDamp = slider;
    }
}
